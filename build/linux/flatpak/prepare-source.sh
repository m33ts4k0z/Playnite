...
test -f "$payload_dir/lib/playnite/desktop/Themes/Desktop/Default/Views/AddonStore.axaml"
test -f "$payload_dir/lib/playnite/fullscreen/Themes/Fullscreen/Default/Theme.axaml"
test -f "$payload_dir/lib/playnite/fullscreen/Assets/Prompts/xbox-a.svg"
